...
class Trimmer {
  ...
  Future<String> saveTrimmedVideo({
    ...
    String _trimLengthCommand = ' -ss $startPoint -i "$_videoPath" -c:v libx264 -preset ultrafast -crf 18 -c:a aac -movflags +faststart -t ${endPoint - startPoint} -avoid_negative_ts make_zero ';
